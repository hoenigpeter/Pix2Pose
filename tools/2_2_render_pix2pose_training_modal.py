...
for m_id,model_id in enumerate(model_ids):
        ...
        for img_id in range(len(rgb_files)):
            ...
            for gt in gt_img:            
                ...
                img_r_raw,depth_rend,bbox_gt = get_rendering(obj_model,rot_pose,tra_pose,ren)
                ...
                if new_data[:,:,3:6].shape[0] > 15 and new_data[:,:,3:6].shape[1] > 15 and new_data[:,:,:3].shape[0] > 15 and new_data[:,:,:3].shape[1] > 15 and visibility_percentage_bbox > 0.1:
