...
# # Limit GPU memory growth (as mentioned in the previous response)
# gpus = tf.config.experimental.list_physical_devices('GPU')
# if gpus:
#     for gpu in gpus:
#         tf.config.experimental.set_memory_growth(gpu, True)

# # Optionally, limit the GPU memory fraction (if required)
...
#                 gpu,
#                 [tf.config.experimental.VirtualDeviceConfiguration(memory_limit=4096)])  # Set the memory limit as required
