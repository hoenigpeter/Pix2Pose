...
if(dataset=='tless'):
    output_path = os.path.join(output_dir,"pix2pose-w-icp-iccv19_"+dataset+"-test-primesense.csv")
else:
    output_path = os.path.join(output_dir,"pix2pose-w-icp-iccv19_"+dataset+"-test.csv")
