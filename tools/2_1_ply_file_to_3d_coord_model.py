...
dataset = sys.argv[2]
bop_dir,source_dir,model_plys,model_info,model_ids,rgb_files,depth_files,mask_files,mask_files_visib,gts,cam_param_global = bop_io.get_dataset(cfg,dataset)
